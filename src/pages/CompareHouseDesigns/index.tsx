  ...
  return (
    ...
    >
      <div className="px-[15rem] mobile:px-2">
        ...
        <Grid className="grid-cols-3 gap-x-[20px] gap-y-[20px] tablet:grid-cols-2 mobile:grid-cols-2">
          {houseList.map((v: any, i: number) => {
            return (
              <div
                key={i}
                className={(i === 2 && 'tablet:hidden mobile:hidden') || ''}
              >
                  ...
                  return (
                    <div key={qi}>
                      <IconVerticalButton
                        ...
                        iconWidth={33}
                        iconHeight={30}
                        text={quick.num + ' ' + quick.name}
                      ></IconVerticalButton>
                      <Gap
                        className={(qi === 3 && 'hidden') || ''}
                        size={40}
                      ></Gap>
                    </div>
                  );
            ...
            return (
              <Image
                ...
                className={`button-box-shadow w-full ${
                  (i === 2 && 'tablet:hidden mobile:hidden') || ''
                }`}
                src={v.floorImg}
                alt="icon"
                priority
        ...
        <Grid className="grid-cols-3 gap-x-[20px] tablet:grid-cols-2 mobile:grid-cols-2">
          {houseList.map((v: any, i: number) => {
            return (
              <div
                key={i}
                className={`${(i === 2 && 'tablet:hidden mobile:hidden') || i}`}
              >
                {new Array(20).fill('').map((vv: any, ii: number) => {
                  return (
                    <div
                      key={ii}
                      className={`mb-[20px] ${
                        (ii === 2 && 'tablet:hidden mobile:hidden') || ''
                      }`}
                    >
        ...
        <Gap size={20}></Gap>
        <BodyTextGreyBold
          text={'Bathroom/En-suite Features'}
        ></BodyTextGreyBold>
        <Gap size={20}></Gap>
        <Grid className="grid-cols-3 gap-x-[20px] tablet:grid-cols-2 mobile:grid-cols-2">
          {houseList.map((v: any, i: number) => {
              ...
              >
                {new Array(2).fill('').map((vv: any, ii: number) => {
                  return (
                    ...
                    >
                      <CheckBox
                        text="Interim Occupation Certificate"
                        isChecked={true}
                      ></CheckBox>
                    </div>
                  );
