    ...
    return (
        ...
        >
            <div className="banner select-none bg-cover bg-[url('../assets/index/banner.png')] mobile:bg-[url('../assets/index/banner-small-screen.png')]">
                ...
                <div className={`search mobile:!hidden ${currentType ? '!bg-[#F2F2F2]' : ''} `}>
                    ...
                    <div
                        className={`
                            ...
                            mt-[-2px]
                            ${currentType === 'Location' ? 'bg-white' : ''}
                            ${currentType ? 'w-[7.5rem] pl-[1.25rem] right-[-4rem] !text-left' : ''}
                        `}
                    >
                        <Image
                            className={`
                ...
                <div className={`${currentType === 'Filters' ? 'block' : 'hidden'} button-box-shadow w-[31.0625rem] h-[21rem] p-[2.5rem] bg-[#fff] mx-auto rounded-xl text-left relative`}>
            ...
            <Slider></Slider>
            <div className='mt-[4.6875rem] py-[4.6875rem] text-center bg-cover' style={{ backgroundImage: `url(${ModuleBg.src})` }}>
