    ...
    return (
        ...
        >
            <div className='px-[8rem]'>
                ...
                <Gap className='hidden mobile:block' size={20}></Gap>
                <Image className='desktop:px-[418px] w-[100%]' src={img1} alt="img" priority />
                <Gap className='mobile:hidden' size={40}></Gap>
                <Gap className='hidden mobile:block' size={20}></Gap>
                <BodyTextLight className='desktop:px-[418px]' text={'Slowly but surely, I was getting closer to getting a lot.'}></BodyTextLight>
                <BodyTextLight className='desktop:px-[418px]' text={`I must admit, the sales staff were brutal. There was no mercy for the late. I recall one couple arriving the same time that I did but must have not heard their number being called out. As the sales staff progressed to the following number the couple approached the sales staff saying that they had missed their number. The sales staff simply said "No, it is too late." Not even a single "sorry" was given. Yeah, it was their own fault but you couldn't help feeling sorry for the guys. In saying this, another one had bit the dust *fist pump again*.`}></BodyTextLight>
                <BodyTextLight className='desktop:px-[418px]' text={`After an excruciating 3 hours, they called up "58". With only 3 blocks left, I did it. I got the chance to buy a block.`}></BodyTextLight>
                <Gap className='mobile:hidden' size={75}></Gap>
                <Gap className='hidden mobile:block' size={40}></Gap>
                <Title4 className='desktop:px-[418px]' text="What type of block did you end up buying?"></Title4>
                <Gap size={20}></Gap>
                <BodyTextLight className='desktop:px-[418px]' text={`The block of land was only 250m2 and the cost was $270,000. I didn't even know they could build houses on such a small block. I called up my brother who works as a lawyer and asked for some free legal advice. He has a lot of builder clients which was handy. After a quick call, I had the green light to go ahead. I paid the $300.00 administration fee and the rest is history.`}></BodyTextLight>
                <BodyTextLight className='desktop:px-[418px]' text={`Registration of the land took 15 months which was a little longer than expected but it worked out well for me. During this time, Sydney house prices kept sky rocketing. By the time I settled the land, my bank had valued the land to be worth $320,000. An instant $50,000 in equity. Kaching! Winning.`}></BodyTextLight>
                <BodyTextLight className='desktop:px-[418px]' text={`Here is a picture of my block. Doesn't look like much for a quarter of a million dollars - but I am grateful that I got one. If you look closely, it is the tiny one in the middle between those 2 fence posts.`}></BodyTextLight>
                <Gap className='mobile:hidden' size={75}></Gap>
                <Gap className='hidden mobile:block' size={40}></Gap>
                <Image className='desktop:px-[418px] w-[100%]' src={img2} alt="img" priority />
                <Gap className='mobile:hidden' size={75}></Gap>
                <Gap className='hidden mobile:block' size={40}></Gap>
                <Title4 className='desktop:px-[418px]' text="What sort of design did you end up doing?"></Title4>
                <BodyTextLight className='desktop:px-[418px]' text={`Below is the floor plan for the house. It was a custom design as the block was so small. This was the biggest hurdle in trying to maximise the use of the land.`}></BodyTextLight>
                <Gap className='mobile:hidden' size={40}></Gap>
                <Gap className='hidden mobile:block' size={20}></Gap>
                <Image className='desktop:px-[418px] w-[100%]' src={img3} alt="img" priority />
                <Gap className='mobile:hidden' size={40}></Gap>
                <Gap className='hidden mobile:block' size={20}></Gap>
                <Image className='desktop:px-[418px] w-[100%]' src={img4} alt="img" priority />
                <Gap className='mobile:hidden' size={40}></Gap>
                <Gap className='hidden mobile:block' size={20}></Gap>
                <BodyTextLight className='desktop:px-[418px]' text={`There are 4 bedrooms upstairs including a sitting area. Another bedroom/study downstairs with a separate sitting room as you enter the house. The "feng shei" was not the best as the chi could enter the front door and exit the back, so I had to introduce a sliding door near the garage to keep all the good chi in the house. By all means, I am no expert in feng shei but this was recommended by my mum, so I did it.`}></BodyTextLight>
                <BodyTextLight className='desktop:px-[418px]' text={`The backyard is tiny but who needs a backyard when you are surrounding by facilities and parks?`}></BodyTextLight>
                <Gap className='mobile:hidden' size={75}></Gap>
                <Gap className='hidden mobile:block' size={40}></Gap>
                <Title4 className='desktop:px-[418px]' text="How long was the build process?"></Title4>
                <Gap size={20}></Gap>
                <BodyTextLight className='desktop:px-[418px]' text={`The house has been in construction for a little over 6 months (which included the "shutdown" period over Christmas) so we are not going too bad on time. The builder has told me that we are on the home stretch and the house should be complete in the next few weeks. Once complete, I am going to rent the house out. As I had mentioned briefly, one of the best deductions (besides negative gearing) is depreciation. If you are an investor who has just built a new home, you should get a depreciation report for the property. The cost of $500 for the report will save you thousands and thousands in deductions and tax.`}></BodyTextLight>
                <BodyTextLight className='desktop:px-[418px]' text={`Here are some pictures of the build process which you may like.`}></BodyTextLight>
                <Gap className='mobile:hidden' size={40}></Gap>
                <Gap className='hidden mobile:block' size={20}></Gap>
                <ButtonOnImg className='desktop:px-[418px] relative' imgSrc={img5}>
                    <Link className='absolute bottom-[30px] right-[448px]' href='/Album'>
                        <Button className=' bg-white body-text-grey-bold py-2' text='Show All Photos'></Button>
                    </Link>
                </ButtonOnImg>
                <Gap className='mobile:hidden' size={75}></Gap>
                <Gap className='hidden mobile:block' size={40}></Gap>
                <Title4 className='desktop:px-[418px]' text="So let's talk about the financials. What were the numbers?"></Title4>
                <BodyTextLight className='desktop:px-[418px]' text={`The cost of my build was $305,000. There was an additional $25,000 in upgrades/extras (such as raised ceilings, down lights, etc). As the block was so small, my main goal was to make the house as big as possible. With the land cost being $270,000, my total cost to buy and build was around $600,000. If you look at realestate.com.au, the average house price in Edmondson Park is around $700,000 and $750,000 (conservatively). Putting aside interest cost and what not, I am looking at up to $150,000 in equity, which I will then use for my next project.`}></BodyTextLight>
                <Gap className='mobile:hidden' size={40}></Gap>
                <Gap className='hidden mobile:block' size={20}></Gap>
                <Image className='desktop:px-[418px] w-[100%]' src={img6} alt="img" priority />
                <Gap className='mobile:hidden' size={75}></Gap>
                <Gap className='hidden mobile:block' size={40}></Gap>
            </div>
