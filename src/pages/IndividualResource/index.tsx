    ...
    >
      <div className="px-[8rem] mobile:px-[2rem]">
        ...
        <Title3
          ...
          text="5 Tips For Anyone Constructing a New Home"
        ></Title3>
        <Gap size={10}></Gap>
        <BodyText
          className="desktop:px-[418px]"
          text="Written by Alex Morrison · Time to read · Category "
        ></BodyText>
        ...
        <Title4
          className="desktop:px-[418px]"
          text="5. Actively Take Part in the Building Process"
        ></Title4>
        <Gap size={20}></Gap>
        <BodyText
          className="desktop:px-[418px]"
