...
export type GetArticleQuery = { __typename?: 'RootQuery', Article: { __typename?: 'Article', _id: string | null, title: string | null } | null };
...
export type GetArticlesQuery = { __typename?: 'RootQuery', allArticle: Array<{ __typename?: 'Article', _id: string | null, title: string | null, articleType: string | null, image: { __typename?: 'Image', asset: { __typename?: 'SanityImageAsset', url: string | null, size: number | null } | null } | null, person: { __typename?: 'Person', name: string | null } | null }> };
...
export type GetBuilderQuery = { __typename?: 'RootQuery', Builder: { __typename?: 'Builder', title: string | null, licenseNo: string | null, sinceYear: number | null, description: string | null, website: string | null, logo: { __typename?: 'Image', asset: { __typename?: 'SanityImageAsset', url: string | null } | null } | null, awards: Array<{ __typename?: 'Image', asset: { __typename?: 'SanityImageAsset', url: string | null } | null } | null> | null } | null };
...
export type GetBuildersQuery = { __typename?: 'RootQuery', allBuilder: Array<{ __typename?: 'Builder', _id: string | null, title: string | null, licenseNo: string | null, sinceYear: number | null, website: string | null, logo: { __typename?: 'Image', asset: { __typename?: 'SanityImageAsset', url: string | null } | null } | null }> };

export type GetBuildersLogoQueryVariables = Exact<{
  where?: InputMaybe<BuilderFilter>;
  sort?: InputMaybe<Array<BuilderSorting> | BuilderSorting>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
...
export type GetBuildersLogoQuery = { __typename?: 'RootQuery', allBuilder: Array<{ __typename?: 'Builder', _id: string | null, logo: { __typename?: 'Image', asset: { __typename?: 'SanityImageAsset', url: string | null } | null } | null }> };
...
export type GetAllSettingsQueryVariables = Exact<{
  where?: InputMaybe<SettingsFilter>;
  sort?: InputMaybe<Array<SettingsSorting> | SettingsSorting>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  offset?: InputMaybe<Scalars['Int']['input']>;
}>;
...
export type GetStoriesQuery = { __typename?: 'RootQuery', allArticle: Array<{ __typename?: 'Article', title: string | null }> };
...
export const GetBuildersDocument = gql`
  ...
  allBuilder(where: $where, sort: $sort, limit: $limit, offset: $offset) {
    ...
    `;
export const GetBuildersLogoDocument = gql`
    query GetBuildersLogo($where: BuilderFilter, $sort: [BuilderSorting!], $limit: Int, $offset: Int) {
  allBuilder(where: $where, sort: $sort, limit: $limit, offset: $offset) {
    _id
    logo {
      asset {
...
export const GetHouseDesignDocument = gql`
  ...
  HouseDesign(id: $id) {
    ...
    nichesAlcoves
    overheadCupboards
    kitchenGlassSplashback
    kitchenStoneBenchtop
    softCloseDrawers
    dishwasherMicrowaveProvision
    oven
    cooktop
    rangehood
    dishwasher
    microwave
    floorToCeilingTiles
    framelessShowerScreen
    bathroomStoneBenchtop
    ensuiteDoor
    softCloseToiletSeat
    ...
    downLights
    outdoorUpDownLights
    interimOccupationCertificate
    finalOccupationCertificate
  }
}
    `;
...
export const GetAllSettingsDocument = gql`
    query GetAllSettings($where: SettingsFilter, $sort: [SettingsSorting!], $limit: Int, $offset: Int) {
...
export const GetStoriesDocument = gql`
    query GetStories($where: ArticleFilter, $sort: [ArticleSorting!], $limit: Int, $offset: Int) {
  allArticle(where: $where, sort: $sort, limit: $limit, offset: $offset) {
    title
  }
}
